...
public class JooqTimeReportService implements TimeReportService {
    ...
    public TimeDataSource createTimeReport(Long projectId, Month month, int year) {
        List<TimeTracking> timeTrackings = repository.findBillableHoursByProject(projectId);
        ...
        return new TimeDataSource(projectName, month, year, timeTrackings, companyProperties);
    }

    public byte[] generatePdf(TimeDataSource dataSource) {
